                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-outline card-primary shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="post_title">Judul pengumuman</label>
                                                <input id="post_title" name="post_title" class="form-control select2" type="text" placeholder="pengumuman Judul..." value="" required>

                                            </div>
                                            <div class="form-group">
                                                <label>pengumuman Isi</label>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-outline card-primary shadow-sm">
                                        <div class="card-header">
                                            <h3 class="card-title">pengumuman Info</h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="post_date">Tanggal pengumuman</label>
                                                <input class="form-control gijgo select2" name="post_date" id="post_date" type="text" placeholder="Select a date" required />

                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="post_thumbnail">pengumuman Foto</label>
                                ...
                                <div class="col-md-8 order-last order-md-first">
                                    <div class="card card-outline card-primary shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="post_title">Judul pengumuman</label>
                                                <input id="epost_title" name="epost_title" class="form-control select2" type="text" placeholder="pengumuman Judul..." value="" required>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-outline card-primary shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <img src="" alt="Foto pengumuman" id="foto" class="img-fluid w-100">
            ...
            <form>
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        <p>Apakah Anda yakin Menghapus pengumuman ini?</p>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function EdituploadImage(image) {
            ...
            $.ajax({
                url: "<?= base_url('k_pengumuman/upload_image') ?>",
                cache: false,
                contentType: false,
                processData: false,
                data: data,
        ...
        function EditdeleteImage(src) {
            $.ajax({
                ...
                type: "POST",
                url: "<?= base_url('k_pengumuman/delete_image') ?>",
                cache: false,
        ...
        function tampildata() {
            $('#datapengumuman').DataTable({
                ...
                "ajax": {
                    url: "<?php echo base_url() ?>k_pengumuman/getdata",
                    type: 'GET'
                },
            });
        ...
        $('#inputform').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>k_pengumuman/simpan_pengumuman",
                ...
                success: function(response) {
                    ...
                    if (response == "success") {
                        ...
                        $('#datapengumuman').DataTable().ajax.reload();
        ...
        $('#editform').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>k_pengumuman/simpanedit",
                data: new FormData(this),
                processData: false,
                contentType: false,
                cache: false,
        ...
        // showedit data
        $('#datapengumuman').on('click', '.bedit', function() {
            var id = $(this).attr('data');
            $.ajax({
                type: "GET",
                url: "<?php echo base_url() ?>k_pengumuman/showedit",
                dataType: "JSON",
                data: {
                    id: id
                },
                success: function(data) {
                    $.each(data, function(judul, id, isi, foto, tanggal) {
                        ...
                        $('[id="foto"]').attr("src",
                            "<?php echo base_url() ?>uploads/pengumuman/" + data
                            .foto);
        ...
        //hapus data
        //GET HAPUS
        $('#datapengumuman').on('click', '.bhapus', function() {
            var id = $(this).attr('data');
        ...
        $('#btn_hapus').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>k_pengumuman/hapus_pengumuman",
                data: {
                    id: kode
                },
                success: function(response) {
