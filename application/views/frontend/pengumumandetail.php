        ...
        <div class="container">
            <div class="sec-title text-center w-100">
                <div class="sec-title-inner d-inline-block">
                    ...
                    <h2 class="mb-0"><?php echo $detail->pengumuman_judul ?></h2>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-9">
                        <div class="post-detail-inner w-100">
                            <div class="post-detail-img w-100">
                                <img class="img-fluid w-100" src="<?php echo base_url() ?>uploads/pengumuman/<?php echo $detail->pengumuman_foto ?>" alt="Blog Detail Image 1">
                            </div>
                            <div class="post-detail-info position-relative w-100">
                                <div class="post-info2-inner text-center">
                                    <div class="post-date2">
                                        <span class="d-block"><?php echo date(
                                                                    'd',
                                                                    strtotime($detail->pengumuman_waktu)
                                                                ); ?></span>
                                ...
                                <ul class="post-meta2 d-inline-flex flex-wrap align-items-center mb-0 list-unstyled">
                                    <li class="thm-clr"><?php
                                                        $now = time();
                                                        echo timespan(strtotime($detail->pengumuman_waktu), $now) . ' ago'; ?></li>
                                ...
                                <!-- isinya disini -->
                                <h5 class="mb-0 mb-3"><?php echo $detail->pengumuman_judul ?></h5>
                                <p><?php echo $detail->pengumuman_isi; ?></p>
