...
class M_gallery extends CI_Model
{
    ...
    {
        $this->galleryTbl   = 'tbl_galeri';
        $this->imgTbl = 'tbl_foto_galeri';
    }
    ...
    function get_data()
    {
        ...
        $query  = $this->db->query("SELECT tbl_galery.* , tbl_user.user_nama AS namauser FROM  tbl_galery, tbl_user WHERE tbl_galery.`galeri_user` = tbl_user.user_id");
        return $query;
    }
    ...
    public function count_data()
    {
        ...
        $this->db->from('tbl_galery p');
        return $this->db->get()->num_rows();
    }

    public function get_all_galeri($limit, $start)
    {

        $this->db->order_by('galeri_id', 'desc');

        $this->db->join('tbl_user u', 'u.user_id=p.galeri_user', 'left');
        $query = $this->db->get('tbl_galery p', $limit, $start)->result();
        return $query;
    }
    ...
    function get_datadashboard()
    {
        ...
        $query  = $this->db->query("SELECT tbl_galery.* , tbl_user.user_nama AS namauser FROM  tbl_galery, tbl_user WHERE tbl_galery.`galeri_user` = tbl_user.user_id limit 6");
        return $query;
    }
